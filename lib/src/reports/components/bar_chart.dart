import 'package:finany/common/utils/color_extension.dart';
...
class BarChartSample2 extends StatefulWidget {
  ...
  final Color leftBarColor = Kolors.kPrimary;
  final Color rightBarColor = Kolors.kPrimaryLight;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Column(
              children: [
                Text('NetIncome', style: appStyle(14, Kolors.kGrayLight, FontWeight.w400),),
                Text(
                  '\$ 980.50',
